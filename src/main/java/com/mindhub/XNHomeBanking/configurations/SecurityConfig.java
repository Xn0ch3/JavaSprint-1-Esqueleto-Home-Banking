    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth ->
                ...
                auth.requestMatchers("/index.html", "/style.css", "/index.js" , "tailwind.config.js", "/images/**").permitAll()
                        .requestMatchers("/pages/**" , "/JavaScript/**" ,"/pages/*/cards.html","/api/clients/*",
                                "/pages/accounts.html" ,"/api/accounts/*/transactions", "/api/clients/current", "/api/clients/current/accounts",
                                "/api/clients/current/accounts", "/api/clients/current/cards").hasAuthority("CLIENT")
                        ...
                        .anyRequest().denyAll());
        //Desabilitamos el CSRF que desactiva el TOKEN xq si no deberiamos solicitarlo y enviarlo cada vez que realizamos una peticion, el filtro para poder acceder a los Headers,
